...
var Reveal = (function() {
    ...
    const VERTICAL_SLIDES_SELECTOR = '.reveal .slides>section.present>section';
    const HOME_SLIDE_SELECTOR = '.reveal .slides>section:first-of-type';
    ...
    let activateOverviewTimeout = 0;

    // A delay used to deactivate the overview mode
    let deactivateOverviewTimeout = 0;
    ...
    function layout() {
        if ( dom.wrapper && !isPrintingPDF() ) {
            ...
            let availableHeight = dom.wrapper.offsetHeight;
            ...
            let slideHeight = config.height;
            const slidePadding = 20; // TODO Dig this out of DOM
        ...
        if ( config.overview ) {
            ...
            activateOverviewTimeout = setTimeout( function() {
                ...
                for ( let i = 0, len1 = horizontalSlides.length; i < len1; i++ ) {
                    ...
                    const hoffset = config.rtl ? -105 : 105;
    ...
    function slide( h, v, f, o ) {
        ...
        if ( previousSlide ) {
            ...
            if ( document.querySelector( HOME_SLIDE_SELECTOR ).classList.contains( 'present' ) ) {
                // Launch async task
                setTimeout( function() {
                    const slides = toArray( document.querySelectorAll( HORIZONTAL_SLIDES_SELECTOR + '.stack') ); let i;
                    for ( i in slides ) {
                        if ( slides[i] ) {
                            // Reset stack
    ...
    function updateParallax() {
        if ( config.parallaxBackgroundImage ) {
            const horizontalSlides = document.querySelectorAll( HORIZONTAL_SLIDES_SELECTOR );
            const verticalSlides = document.querySelectorAll( VERTICAL_SLIDES_SELECTOR );
    ...
    Playback.prototype.render = function() {
        ...
        const radius = ( this.diameter / 2 ) - this.thickness;
        const x = this.diameter / 2;
        const y = this.diameter / 2;
        const iconSize = 14;
