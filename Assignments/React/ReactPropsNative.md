...
Our goal is to recreate our best current version of GitHubExplorer in React Native. By now you might be calling it GitHubMenu or GitHubMaterial. Whatever our best React Web App code might be, we want to recreate it in React Native.

## Get Started

Create an empty React Native project called **GitHubNative**:

```bash
create-react-native-app GitHubNative
```

## Recreate GitHubShow

Begin by copying over the core files from your best version of **GitHubShow**:

```
cp ../GitHubMaterial/src/components/GitHub.js .
cp ../GitHubMaterial/src/components/GitHubShow.js .
cp ../GitHubMaterial/src/components/GetFile.js .
cp ../GitHubMaterial/src/components/ElfHeader.js .
$ cp ../GitHubMaterial/src/components/elf-styles.js .
$ cp ../GitHubMaterial/src/GitHub-list.js .
```
...
## Link in GitHub Component


Now that we have created the **GitHub** component, all you need to do is link it in. I suggest that you leave GitHubShow out of the mix for now, as it is the most time consuming component to fix up.
...
[nasm]: https://s3.amazonaws.com/bucket01.elvenware.com/images/native-GitHub-simple-menu.png

[nagf]: https://s3.amazonaws.com/bucket01.elvenware.com/images/native-GitHub-get-file.png
