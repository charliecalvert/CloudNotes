...
Duplicate the "Longer Document" and the Ozymandias poem in two separate markdown files. Attach the files to your assignment. Just the raw text should be fine. I don't think you need to use a zip file. In Remarkable, save the text as HTML and paste it into two pages in your Google Site. Provide links to your pages when you turn in the assignment. 
