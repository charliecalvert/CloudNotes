...
Put at least one page in each sub-directory and link to it from your theme home page.
...
By now, you all should be familiar with the process of pushing your pages to GitHub and viewing them on the GitHub Pages site.
...
The contents of **index.html** should contain links that point directly to pages in your root folder and to the **index.html** file in your **theme**, **ListButton** and other subdirectories that contain code you have created. On your site Home Page, I want to see links to not only your theme folder, but all the assignments we have created so far in this course.
...
I'm expecting to see CSS in, at minimum, a directory called **Styles** or **styles**, and in the **ListButton** directory. Many of you will also have CSS in your **theme** directory or in a sub-directory of your **theme** directory. You must style your pages.
...
When you turn in the assignment, provide a link to the home page of your running website. I'm looking for a URL leading to your website running on GitHub pages. Since you need to turn in multipe links, the simplest approach will probably be to use the Text page of Canvas when submitting the assignment.
