...
function playExample(keyChoice, pattern) {
    const Synth = function(audiolet, frequency) {
    ...
    const SchedulerApp = function() {
        ...
        const chordPattern = this.getChord(1);
    ...
    SchedulerApp.prototype.getChord = function() {
        ...
        // I IV V progression
        const chordPattern = new PSequence(data[pattern]);
        return chordPattern;
    };
