...
ECHO   set ELVENWARE=C:\GitHub
ECHO   set GIT_WRITING=C:\Src\Git\Writing
ECHO   set GITHUB=C:\Src\Git
ECHO   set JSOBJECTS=C:\Src\Git\JsObjects
ECHO   set PYTHON_HOME=C:\Python\Python33
ECHO   set PYTHONPATH=C:\Src\Git\JsObjects\Python
ECHO =============================================