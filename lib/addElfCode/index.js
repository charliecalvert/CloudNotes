...
const { getDataProperties, getFrontMatterData, setQueryPath} = require('./library');
...
---`;
    ...
    if (elfCodes.hasElfCode + elfCodes.hasTocCode === 0) {
        ...
        const matterInfo = getFrontMatterData(debugToc, fileName, relativePath);
        ...
        const matterInfo = getFrontMatterData(debugBoth, fileName, relativePath);
