const { getTitleFromPath, splitStringOnAnyInstanceOfCharacter } = require('elven-code').elfUtils;
const { getDataProperties, 
    getFrontMatterData, setMatterStartFields, setHtmlMmarkdown, setPathsAndTitle,
    setQueryPath, setSubject } = require('./library');
