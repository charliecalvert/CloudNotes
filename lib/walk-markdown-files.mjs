...
for (const fileInfo of fileInfos) {
    ...
    const isMatch = (
        fileInfo.directory.includes(guidePairs.androidGuide.path) ||
        fileInfo.directory.includes(guidePairs.cloudGuide.path) ||
        fileInfo.directory.includes(guidePairs.csharpGuide.path) ||
